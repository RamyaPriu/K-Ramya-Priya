...
function videoplay(){
    ...
    window.location="videoplay1.html"
}
...
function videoplay2(){
    console.log(" Hi Ramya Priya")
    window.location="videoplay2.html"
}
...
function videoplay3(){
    console.log(" Hi Ramya Priya")
    window.location="videoplay3.html"
}
...
function videoplay4(){
    console.log(" Hi Ramya Priya")
    window.location="videoplay4.html"
}
...
function videoplay5(){
    console.log(" Hi Ramya Priya")
    window.location="videoplay5.html"
}
...
function videoplay6(){
    console.log(" Hi Ramya Priya")
    window.location="videoplay6.html"
}
...
function videoplay7(){
    console.log(" Hi Ramya Priya")
    window.location="videoplay7.html"
}
...
function videoplay8(){
    console.log(" Hi Ramya Priya")
    window.location="videoplay8.html"
}
